---
title: Maunal Installation Instructions for SPT 4.1
description: 
published: false
date: 2026-08-20T15:50:05.040Z
tags: 
editor: markdown
...
1. Download the patcher from the `4.1` section [here](https://patcher.sp-tushonka.com/mirrors.json).
...
6. Download the SPT release archive from [here](https://patcher.sp-tushonka.com/releases/SPT-4.1.2-40743-cf04a11.7z).
...
Once you have completed the above, you can now play SPT and install mods found on [The Forge](https://sp-mod.com/). You can find a guide on how to correctly install SPT mods on the [Installing Mods](/SPT_4x/Installing_Mods) Wiki page. **Make sure to only install versions of mods made for 4.1.**
